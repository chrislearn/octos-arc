...
zip -qr ../octos-arc-bundle.zip main.py rust_engine.py arc-policy.toml prompts octos_stdio.py requirement_order.py acceptance.py web_checks.py frontend_assets.py verify_app.py action_errors.cjs page_errors.ts guard.py llm_proxy.py codegen.py generic_template.py web_stack.py blueprints hooks requirements.txt arcbench_agent_runtime public-tests -x '*/__pycache__/*' '*.pyc'
if [ -n "$ROUTES" ]; then
