...
最后更新：2026-09-14 13:40 UTC。预置口径（统筹 09-14 定）：费用 < ¥0.001 且耗时 < 5 s；其余费用 > 0 的全算对手。「达成」只认云端数字且需连续两次。

| 赛道 | 我们（最好账号） | 满分对手（前 3，按费用） | 目标 | 差距（对最便宜满分对手） | 状态 |
|---|---|---|---|---|---|
| Smoke | 李尧 100% ¥0.0051 / 23s | 你也秃对不队 ¥0.0031/2s；Orchestra ¥0.0037/4s；niceeeeee ¥0.0171/10s | 两题合计 ≤ ¥0.0028 | ¥+0.0020 | 未达成 |
| Smoke Evolution | octos 100% ¥0.0055 / 36s | Orchestra ¥0.0046/4s；niceeeeee ¥0.0188/8s；包子头队 ¥0.0950/20s | 两题合计 ≤ ¥0.0040 | ¥+0.0009 | 未达成 |
| Ticket Booking | octos 90% ¥0.1344 / 100s | net1111 ¥0.3628/356s；Orchestra ¥0.6059/639s；VOLO AI ¥0.6297/279s | 10/10 稳定且 ≤ ¥0.15（连续两次） | 通过率 90% 未满分；满分最低对手 ¥0.3628 | 未达成 |
| ARC-Bench Web | 未上榜 | 无满分对手 | 六题完成即第一，随后压总费用 | — | 未上榜（六题完成 2/6，stackoverflow 进行中） |
